...
/**
 * REST controller for managing {@link si.eclectic.psyhub.domain.Address}.
 */
@RestController
...
public class AddressResource {
    ...
    public ResponseEntity<List<Address>> getAllAddresses(
        ...
        if ("office-is-null".equals(filter)) {
            log.debug("REST request to get all Addresss where office is null");
            return new ResponseEntity<>(addressService.findAllWhereOfficeIsNull(), HttpStatus.OK);
        }
