...
describe('Address Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call City query and add missing value', () => {
      ...
      const city: ICity = { id: 12071 };
      address.city = city;

      const cityCollection: ICity[] = [{ id: 14944 }];
    ...
    it('Should call Country query and add missing value', () => {
      const address: IAddress = { id: 456 };
      const country: ICountry = { id: 28495 };
      address.country = country;

      const countryCollection: ICountry[] = [{ id: 11058 }];
    ...
    it('Should update editForm', () => {
      const address: IAddress = { id: 456 };
      const city: ICity = { id: 29680 };
      address.city = city;
      const country: ICountry = { id: 15470 };
      address.country = country;
