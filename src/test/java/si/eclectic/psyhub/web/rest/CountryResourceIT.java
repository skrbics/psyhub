...
class CountryResourceIT {
    ...
    public static Country createEntity(EntityManager em) {
        Country country = new Country().name(DEFAULT_NAME).abbreviation(DEFAULT_ABBREVIATION);
        return country;
    }
    ...
    public static Country createUpdatedEntity(EntityManager em) {
        Country country = new Country().name(UPDATED_NAME).abbreviation(UPDATED_ABBREVIATION);
        return country;
    }
    ...
    void createCountry() throws Exception {
        ...
        assertThat(testCountry.getAbbreviation()).isEqualTo(DEFAULT_ABBREVIATION);
    }
    ...
    void putExistingCountry() throws Exception {
        ...
        updatedCountry.name(UPDATED_NAME).abbreviation(UPDATED_ABBREVIATION);
        ...
        assertThat(testCountry.getAbbreviation()).isEqualTo(UPDATED_ABBREVIATION);
    }
    ...
    void fullUpdateCountryWithPatch() throws Exception {
        ...
        partialUpdatedCountry.name(UPDATED_NAME).abbreviation(UPDATED_ABBREVIATION);
