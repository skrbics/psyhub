...
class AddressResourceIT {
    ...
    public static Address createEntity(EntityManager em) {
        Address address = new Address().street(DEFAULT_STREET).houseNo(DEFAULT_HOUSE_NO);
        return address;
    }
    ...
    public static Address createUpdatedEntity(EntityManager em) {
        Address address = new Address().street(UPDATED_STREET).houseNo(UPDATED_HOUSE_NO);
        return address;
    }
    ...
    void putExistingAddress() throws Exception {
        ...
        updatedAddress.street(UPDATED_STREET).houseNo(UPDATED_HOUSE_NO);
    ...
    void partialUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.houseNo(UPDATED_HOUSE_NO);
    ...
    void fullUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.street(UPDATED_STREET).houseNo(UPDATED_HOUSE_NO);
