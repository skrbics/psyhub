...
class CityResourceIT {
    ...
    public static City createEntity(EntityManager em) {
        City city = new City().name(DEFAULT_NAME).zip(DEFAULT_ZIP);
        return city;
    }
    ...
    public static City createUpdatedEntity(EntityManager em) {
        City city = new City().name(UPDATED_NAME).zip(UPDATED_ZIP);
        return city;
    }
    ...
    void putExistingCity() throws Exception {
        ...
        updatedCity.name(UPDATED_NAME).zip(UPDATED_ZIP);
    ...
    void partialUpdateCityWithPatch() throws Exception {
        ...
        partialUpdatedCity.name(UPDATED_NAME).zip(UPDATED_ZIP);
