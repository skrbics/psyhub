...
class SessionResourceIT {
    ...
    public static Session createEntity(EntityManager em) {
        Session session = new Session().date(DEFAULT_DATE).location(DEFAULT_LOCATION).notes(DEFAULT_NOTES).completed(DEFAULT_COMPLETED);
        return session;
    }
    ...
    public static Session createUpdatedEntity(EntityManager em) {
        Session session = new Session().date(UPDATED_DATE).location(UPDATED_LOCATION).notes(UPDATED_NOTES).completed(UPDATED_COMPLETED);
        return session;
    }
    ...
    void createSession() throws Exception {
        ...
        assertThat(testSession.getNotes()).isEqualTo(DEFAULT_NOTES);
        assertThat(testSession.getCompleted()).isEqualTo(DEFAULT_COMPLETED);
    }
    ...
    void putExistingSession() throws Exception {
        ...
        updatedSession.date(UPDATED_DATE).location(UPDATED_LOCATION).notes(UPDATED_NOTES).completed(UPDATED_COMPLETED);
        ...
        assertThat(testSession.getNotes()).isEqualTo(UPDATED_NOTES);
        assertThat(testSession.getCompleted()).isEqualTo(UPDATED_COMPLETED);
    }
    ...
    void partialUpdateSessionWithPatch() throws Exception {
        ...
        partialUpdatedSession.date(UPDATED_DATE).location(UPDATED_LOCATION);
    ...
    void fullUpdateSessionWithPatch() throws Exception {
        ...
        partialUpdatedSession.date(UPDATED_DATE).location(UPDATED_LOCATION).notes(UPDATED_NOTES).completed(UPDATED_COMPLETED);
